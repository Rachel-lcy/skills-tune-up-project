...
export default function Home() {
  ...
  // Centralized handler for all CTAs.
  // If the user is not signed in, open the modal.
  // If already signed in, go straight to /program.
  ...
  // Called by AuthModal after a successful sign-in.
  ...
  return (
    <div>
      <main className="min-h-screen overflow-x-hidden">
        {/* HERO */}
        <section id="hero" className="relative w-full h-[80vh] font-sans">
          {/* Background image */}
          <Image
            src="/hero.png"
            alt="Hero Banner"
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start px-8 sm:px-20 text-white z-10">
            ...
            <button
              ...
              className="mt-6 bg-yellow-400 text-black font-bold py-3 px-6 rounded hover:bg-yellow-500 transition"
            >
              Join the Program
            </button>
          </div>
          ...
          <div className="absolute bottom-0 left-0 w-full h-[48px] bg-[#3E86F5] z-10" />
        </section>
        ...
        <section id="program" className="mt-20">
          <div className="bg-yellow-400 w-full grid grid-cols-1 md:grid-cols-2 items-center gap-10 px-10 py-16">
            ...
            <div className="text-left space-y-6 tracking-widest">
              ...
              <button
                onClick={handleAuthClick}
                className="bg-blue-500 text-white font-bold py-3 px-6 rounded-md shadow-md hover:bg-blue-800 transition duration-300"
              >
                Enroll Now
              </button>
            </div>
        ...
        <section id="features" className="bg-[#fcfbfb] relative w-full pt-8 pb-16">
          ...
          <div className="max-w-7xl mx-auto px-4 mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center space-y-4">
              <Image src="/yellow.png" width={40} height={40} alt="Feature" />
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              <Image src="/blue.png" width={40} height={40} alt="Feature" />
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              <Image src="/blue.png" width={40} height={40} alt="Feature" />
              <p>Student-led role-playing & story-telling for engaging learning</p>
            </div>
          </div>
        </section>
        ...
        <section id="cta" className="bg-blue-500 w-full py-20">
          <div className="relative max-w-6xl mx-auto rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center text-white p-10 h-[500px]">
              ...
              <button
                onClick={handleAuthClick}
                className="mt-6 bg-white text-blue-600 font-bold py-3 px-6 rounded-xl shadow-md hover:bg-blue-100 transition duration-300"
              >
                Register Today
              </button>
            </div>
      ...
      {/* Auth modal with success callback that routes to /program */}
      <AuthModal
        open={showAuth}
